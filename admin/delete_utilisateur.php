<?php    
    ...
    if(!empty($_POST)) 
    {
        ...
        $statement = $db->prepare("DELETE FROM login WHERE id_log = ?");
				...
				<div class="red-bar">
			         <div class="administration-trombi">
						<div class="row">
							...
							<div class="col-md-7 col-sm-7 col-xs-7">
								<form class="form" action="delete_utilisateur.php" role="form" method="post">
									<legend style="width: 380px;"><span style="color: #6DA542;"> <em>Administration - Supprimer un utilisateur</em></span></legend>
